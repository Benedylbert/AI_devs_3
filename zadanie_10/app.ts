...
const BASE_PATH = join(__dirname, 'atrykul');
const rynekFile = join(BASE_PATH, 'rynek.webp');
const rynekGlitchFile = join(BASE_PATH, 'rynek_glitch.webp');
...
async function sendRequestToCentrala() {
  ...
  // console.log(responseWithText.transcriptionAudio); 
  // console.log(responseWithText.rynekGlitchOpis);
  // console.log(responseWithText.rynekOpis);
  // console.log(responseWithText.strangeFruitFileOpis);
  // console.log(responseWithText.fruit01FileOpis);
  // console.log(responseWithText.fruit02FileOpis);
  // console.log(responseWithText.resztkiFileOpis);
